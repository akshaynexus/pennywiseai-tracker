...
object StatementTransactionEnricher {
    ...
    fun enrich(existing: TransactionEntity, statement: TransactionEntity): TransactionEntity {
        ...
        val merchantName = if (shouldUseStatementValue(existing.merchantName, statement.merchantName)) {
            changed = true
        ...
        val description = if (shouldUseStatementValue(existing.description, statement.description)) {
            changed = true
    ...
    private fun shouldUseStatementValue(existing: String?, statement: String?): Boolean {
